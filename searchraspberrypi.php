                            ...
                            <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--black">
                                <nav aria-label="breadcrumb">
                                    <ul>
                                        ...
                                        <li class="active" aria-current="page">Raspberry Pi</li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row flex-column-reverse flex-lg-row-reverse">
                    ...
                    <div class="col-lg-9">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM products_table where manufacturer = 'Raspberry' limit $start,9";
                                    ...
                                    <div class="sort-box d-flex justify-content-between align-items-md-center align-items-start flex-md-row flex-column"
                                        ...
                                        <div class="sort-tablist d-flex align-items-center">
                                            ...
                                            <div class="page-amount ml-2">
                                                <?php
                                                    require "config/connect.php";
                                                    $sql2 = "SELECT * FROM products_table where manufacturer = 'Raspberry';";
                                        ...
                                        <div class="tab-content tab-animate-zoom">
                                            ...
                                            <ul> 
                                                <?php
                                                    ...
                                                    $sql1 = "SELECT * FROM products_table where manufacturer = 'Raspberry';";
                                                    ...
                                                    {
                                                        echo "
                                                        <li><a href='searchadafruit.php?page=".$i."'>".$i."</a></li>
                                                        ";
                                                    }
                                                ?>
                                            </ul>
