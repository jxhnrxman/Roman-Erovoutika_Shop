                                ...
                                <nav aria-label="breadcrumb">
                                    <ul>
                                        ...
                                        <?php
                                                ...
                                                $search1 = mysqli_real_escape_string($conn, $_POST['searchbar']);  
                                                $sql2 = "SELECT * FROM products_table where descriptionn like '%$search1%' or manufacturer like '%$search1%';";
                ...
                <div class="row flex-column-reverse flex-lg-row-reverse">
                    ...
                    <div class="col-lg-9">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM products_table where descriptionn like  '%$search%' or manufacturer like '%$search%';";
                                    ...
                                    <div class="sort-box d-flex justify-content-between align-items-md-center align-items-start flex-md-row flex-column"
                                        ...
                                        <div class="sort-tablist d-flex align-items-center">
                                            ...
                                            <div class="page-amount ml-2">
                                                <?php
                                                require "config/connect.php";
                                                $search2 = mysqli_real_escape_string($conn, $_POST['searchbar']);  
                                                $sql2 = "SELECT * FROM products_table where descriptionn like '%$search1%' or manufacturer like '%$search2%';";
                                                $result2 = $conn->query($sql2);
                                                $count2 =  "Showing $result2->num_rows results";
                                                echo $count2;
                                                ?>
