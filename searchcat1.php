        ...
        <div class="breadcrumb-section breadcrumb-bg-color--white">
            <div class="breadcrumb-wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="breadcrumb-title">Search Results</h3>
                            <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--black">
                                <nav aria-label="breadcrumb">
                                    <ul>
                                        ...
                                        <li class="active" aria-current="page">Microcontrollers</li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row flex-column-reverse flex-lg-row-reverse">
                    <div class="col-lg-3">
                        ...
                        <div class="siderbar-section" data-aos="fade-up" data-aos-delay="0">
                            ...
                            <!-- Start Single Sidebar Widget -->
                            <div class="sidebar-single-widget">
                                <h6 class="sidebar-title">COMPONENTS</h6>
                                <div class="sidebar-content">
                    ...
                    <div class="col-lg-9">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM products_table where category_id = 1 limit $start,9";
                                ...
                                <div class="row">
                                    ...
                                    <div class="sort-box d-flex justify-content-between align-items-md-center align-items-start flex-md-row flex-column"
                                        ...
                                        <div class="sort-tablist d-flex align-items-center">
                                            ...
                                            <?php
                                                require "config/connect.php";
                                                $sql2 = "SELECT * FROM products_table where category_id = 1;";
                                        ...
                                        <div class="tab-content tab-animate-zoom">
                                            ...
                                            <ul> 
                                                <?php
                                                    ...
                                                    $sql1 = "SELECT * FROM products_table where category_id = 1;";
                                                    $result1 = $conn1->query($sql1);
                                                    $count1 = $result1->num_rows;
                                                    $total_pages = ceil($count1/9);
                                                    for ($i=1; $i<=$total_pages; $i++)
                                                    {
                                                        echo "
                                                        <li><a href='searchcat1.php?page=".$i."'>".$i."</a></li>
                                                        ";
                                                    }
                                                ?>
                                            </ul>
